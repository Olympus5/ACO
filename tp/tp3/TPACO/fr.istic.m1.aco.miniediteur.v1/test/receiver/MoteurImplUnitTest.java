...
public class MoteurImplUnitTest {
	...
	public void setup() {
		...
		this.moteur.buffer = new StringBuffer("deijfoeffoeuafipu");
	}
	...
	public void copierTest() {
		...
		this.moteur.selection = new Selection(2, 5);

		// test
		this.moteur.copier();

		// asserts
		assertThat(this.moteur.pressePapier).isEqualTo("cde");
	}
	...
	@Test
	public void selectionnerTestOverLengthBuffer() {
		this.moteur.selectionner(99, 99);
